# -*- coding: utf-8 -*-
"""
Created on Sat Dec 12 10:51:22 2020
...
st.title('交通費チェックツール')
st.header('別ウインドウでチェックディレクトリまたはファイルを指定して下さい。')
st.write('始めます！！！') # markdown
...
def CheckExpense(fpath):
   ...
   st.write("input:  ", original_file) # added HK for debug
   ...
   st.write("output folder:  ", os.getcwd()) # added HK for debug
   st.write("output file name:  ", check_file_name) # added HK for debug
